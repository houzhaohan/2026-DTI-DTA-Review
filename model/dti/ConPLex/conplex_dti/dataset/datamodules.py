...
# Compatibility shim for Python 3.12+ with older pkg_resources/pkgutil behavior
if sys.version_info >= (3, 12) and not hasattr(pkgutil, "ImpImporter"):
...
try:
    ...
    def dti_dg_group(*args, **kwargs):
        raise ImportError(
            "The optional 'tdc'/'PyTDC' dependency is not available. "
            "Install PyTDC to use TDC-based datasets. "
