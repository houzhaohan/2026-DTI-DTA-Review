...
class CPIDataset(Dataset):
    ...
    def __init__(self, file_path, compound_data_path, protein_data_path):
        ...
        #smiles_to_remove = ["[Cl-].[K+]", "Br.Br.Br.Br.Br.Br.Br.Br.Br.Br.Br.[Br-].[Ta].[Ta].[Ta].[Ta].[Ta].[Ta+]"]
        #self.raw_data = self.raw_data[~self.raw_data['SMILES'].isin(smiles_to_remove)]
        
        self.smiles_values = self.raw_data['SMILES'].values
        self.sequence_values = self.raw_data['Protein'].values
        self.compound_data_path =  compound_data_path
        self.protein_data_path = protein_data_path

        self.label_values = self.raw_data['Y'].values#.astype(int)
        #print(self.label_values)
        self.prot_id = self.raw_data['Protein_index'].values
    ...
    def __getitem__(self, idx):
        ...
        protein_seq_embedding = np.load(f'{self.protein_data_path}/' + str(self.prot_id[idx])+'.npy').squeeze()
        #print(label)
